...
## Recommended Implementation Phases (REVISED: Hardware-Independent First)
### Phase 2A: Everything But LLM (1.5-2 months)
**Goal**: Complete production system ready for model slot-in
#### 2A.1 DEFERRED: Real LLM Integration
**Priority**: P0 (WAITING ON HARDWARE)
**Effort**: 3-5 days (when hardware arrives)
**Tasks**:
